        ...
        <article class="min-h-full p-5 bg-white rounded-lg flex flex-col">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left w-[45%]">
                    ...
                    <tbody>
                        <tr v-for="category in categories" :key="category.id" class="border-gray-700">
                            <td class="px-6 py-4"> {{ category.categoryName }} </td>
                            <td class="px-6 py-4">
                                <button @click.prevent="destroy(category.categoryID)" class="text-red-700 hover:text-red-400">
